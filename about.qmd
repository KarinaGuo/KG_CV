...
-   First Class Honours
-   2021 Faculty of Science Dean's List
-   University Medal in Ecology
-   WAM: 88.625 / GPA: 6.83
...
-   Applied engagement in concepts of genetics including conducting GWAS on individuals of Melaleuca quinquenervia to discover markers that signify rust resistance
...
-   Rapid selection and preparation of samples to send to Diversity Arrays Technology for genetic sampling
...
<summary>**Honours, Automating the Measurement of Leaf Traits from Herbarium Sheets of Eucalypts using Machine Learning**</summary>
...
-   Interacting with customers to build a relationship and build a safe environment
